...
def lat_long_extract_1(url: str, lat_long_list: list) -> None:
...
def lat_long_extract_2(url: str, lat_long_list: list) -> None:
...
def lat_long_extract_3(url: str, lat_long_list: list) -> None:
